  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(247, 240, 240, 0.7);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">线上购物系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="个人账号" class="input" v-if="tableName=='huiyuan'">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
      if((!this.ruleForm.gerenzhanghao) && `huiyuan` == this.tableName){
